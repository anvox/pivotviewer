KPivotViewer.Views.KFilter.NumberFilter = function() {
  ...
  this.update_to = function(new_data){
    ...
    $placeholder.find('span.min-value').html((this.facet.min + new_data[0]*this.facet.step).toFixed(2));
    $placeholder.find('span.max-value').html((this.facet.min + new_data[1]*this.facet.step).toFixed(2));
  ...
  this.reset = function(){
    ...
    $placeholder.find('span.min-value').html(this.facet.min.toFixed(2));
    $placeholder.find('span.max-value').html(this.facet.max.toFixed(2));
  ...
  this.init_number_filter = function(facet, id, index){
    ...
    $placeholder.find('span.min-value').html(facet.min.toFixed(2));
    $placeholder.find('span.max-value').html(facet.max.toFixed(2));
    ...
    this.slider = $placeholder.find(".slider").slider({
      ...
      slide: function(event, ui) {
        ...
        $placeholder.find('span.min-value').html((facet.min + ui.values[0]*facet.step).toFixed(2));
        $placeholder.find('span.max-value').html((facet.min + ui.values[1]*facet.step).toFixed(2));
  ...
  this.current_filter = function(){
    ...
    return {
      min: (this.facet.min + left*this.facet.step).toFixed(2),
      max: (this.facet.min + right*this.facet.step).toFixed(2)
    };
  };
};