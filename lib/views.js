...
KPivotViewer.Views.total_fields_selector = '.total-candidates';
...
KPivotViewer.Views.GRID_MODE = 'grid';
KPivotViewer.Views.COLUMN_MODE = 'column';

KPivotViewer.Views.canvas_selector = '#myCanvas'
KPivotViewer.Views.stage_width = 600;
KPivotViewer.Views.stage_height = 900;
...
KPivotViewer.Views.view_mode = KPivotViewer.Views.GRID_MODE;
KPivotViewer.Views.min_scale = 0.01;
KPivotViewer.Views.max_scale = 3.0;

// KPivotViewer.Views.init = function(canvasId, width, height, param_detail_selector) {
KPivotViewer.Views.init = function(options) {
  if(options.width != undefined){
    KPivotViewer.Views.stage_width = options.width;
  }
  if(options.height != undefined){
    KPivotViewer.Views.stage_height = options.height;
  }
  if(options.canvas_selector != undefined){
    KPivotViewer.Views.canvas_selector = options.canvas_selector;
  }

  KPivotViewer.Views.detail_panel.init({selector: options.param_detail_selector});

  KPivotViewer.Views.stage = new Kinetic.Stage({
      container: $(KPivotViewer.Views.canvas_selector).attr("id"),
...
KPivotViewer.Views.draw_candidates = function(){
  ...
  if(KPivotViewer.Views.view_mode == KPivotViewer.Views.GRID_MODE){
    KPivotViewer.Views.draw_candidates_as_grid();
  }else if(KPivotViewer.Views.view_mode == KPivotViewer.Views.COLUMN_MODE){
...
KPivotViewer.Views.update_total = function(total){
  $(KPivotViewer.Views.total_fields_selector).html(total);
}
...
KPivotViewer.Views.graph_view = function(){
  ...
  KPivotViewer.Views.view_mode = KPivotViewer.Views.COLUMN_MODE;
  KPivotViewer.Views.draw_candidates();
};
